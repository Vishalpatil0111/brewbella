...
function Menu() {
  ...
  return (
    <div className="overflow-hidden w-full bg-zinc-900">
  <div
  ...
  >
    ...
    {/* Scrolling Text */}
    <div
      className="absolute top-1/2 -translate-y-1/2 whitespace-nowrap flex text-[15vw] tracking-wide uppercase font-light text-[#ddc79f] opacity-35 z-20"
      ref={scrollRef}
    >
